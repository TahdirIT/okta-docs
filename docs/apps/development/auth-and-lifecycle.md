...
Full steps: [`../../reference/web.md`](../../reference/web.md#how-applications-get-installed-into-okta-web).
...
[`../../reference/deployment.md`](../../reference/deployment.md) and
[`../../reference/partners.md`](../../reference/partners.md). For local development against
