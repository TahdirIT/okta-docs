...
> **تمييز مهم — نظاما دفع منفصلان:** هذا المستند يوثّق **بوابة دفع المنصة**
> (فوترة الجهات مقابل اشتراكات المنصة/التطبيقات عبر Neoleap + مزامنة **وافق**
> المحاسبية) داخل `okta-web`. وهو **غير** «مشغّل الدفع الموحّد للتطبيقات الشريكة»
