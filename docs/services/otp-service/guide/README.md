...
> 📎 **هذا الدليل مفاهيمي** (نموذج مثالي)، ويختلف عن التنفيذ الفعلي في نقاط
> (لا Events، لا خطوة Consume منفصلة، cooldown غير مفروض). المرجع المطابق
> للتنفيذ هو [`../README.md`](../README.md) — اقرأه أولاً.
