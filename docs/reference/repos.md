...
|---|---|---|---|
| `okta-web` | The platform/core: owns domain data, exposes services, and hosts installed applications as code; runs in sandbox + production. | PHP 8.3 / Laravel 13, Livewire 4, PostgreSQL, `nwidart/laravel-modules` | [web.md](./web.md) |
| `okta-partners` | The installation/deployment mechanism: author, version, review, publish, and install applications through the bridge into `okta-web`. | PHP 8.3 / Laravel 13, Livewire 4, PostgreSQL, `firebase/php-jwt` | [partners.md](./partners.md) |
