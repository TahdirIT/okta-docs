...
- **تفعيل/تعطيل أنواع الكيانات**: تعطيل نوع كيان يعني عدم ظهوره للمستخدم النهائي في خطوة اختيار نوع الكيان أثناء التسجيل، تعطيل نوع كيان لا يحذف الحقول المخصصة التابعة له، ترتيب أنواع الكيانات يبقى ثابتًا كما هو في `docs/groups/tenants.md`
...
6. **لأنواع الكيانات:** راجع `groups/tenants.md` لفهم أنواع الكيانات وترتيبها
...
- **أنواع الكيانات**: يجب أن تطابق العناوين المعروضة للمستخدم العناوين في `docs/groups/tenants.md`
...
6. `groups/tenants.md` - لفهم أنواع الكيانات
