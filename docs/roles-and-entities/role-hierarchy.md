...
- **شركة تعليمية** (الحاوية العليا) تحتوي:
  - **مجمع** → يحتوي **مدرسة** و**روضة**
  - **جامعة** → تحتوي **كلية**
  - **أكاديمية**
  - **معهد**
  - **كلية** (قد تتبع الشركة مباشرةً أو تحت جامعة)
  - **روضة** (قد تتبع الشركة مباشرةً أو تحت مجمع)

**جهات تشغيلية (تملكها مسؤول حساب، وتدير المستخدمين):**

- **مدرسة** / **كلية** / **أكاديمية** / **معهد** — كلٌّ منها يدير:
  **إداري**، **معلم**، **ولي أمر**، **طالب**.
- **روضة** / **معلم فردي** (جهة مستقلّة) — يدير: **ولي أمر**، **طالب** فقط.
...
|---|---|---|---|
| شركة تعليمية | → | مجمع / جامعة / أكاديمية / كلية / معهد / روضة | احتواء كيان |
| مجمع | → | مدرسة / روضة | احتواء كيان |
| جامعة | → | كلية | احتواء كيان |
| مدرسة | → | إداري / معلم / ولي أمر / طالب | تدير (الجهة ← مستخدموها) |
...
| روضة | → | ولي أمر / طالب | تدير (الجهة ← مستخدموها) |
